...
def read_edge_weight(file, sep='\t'):
    ...
    G.add_nodes_from([index for index in range(len(nodes_second))], bipartite=1)
...
if __name__ == "__main__":
    ...
    model = SDNE(G, node_first_index, node_second_index, hidden_size=[128],)
    #model = SDNE(G, hidden_size=[128],)
